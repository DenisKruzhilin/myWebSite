...
public class TestLinkServiceCenters {
    ...
    private String resultFilePath = Paths.get(System.getProperty("user.dir"), "result__TestLinkServiceCenters.txt").toString();

    @Test
    @DisplayName("ServiceCentersLink")
    public void ServiceCentersLink() {
        ...
        checkElementVisibilityAndLog(Variables.serviceCenters, "Product");
    }
    ...
    private void checkElementVisibilityAndLog(SelenideElement element, String elementName) {
        ...
        boolean isDisplayed = Variables.serviceCentersText.shouldBe(visible).exists();

        logVisibilityResult(elementName, isDisplayed);
        writeTestResult(elementName + " - Успешный переход на страницу сервисные центры", isDisplayed);
    }
    ...
    private void logVisibilityResult(String elementName, boolean isDisplayed) {
        ...
        System.out.println(colorCode + elementName + " - Успешный переход на страницу сервисные центры: " + result);
    }
