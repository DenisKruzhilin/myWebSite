...
public class TestLinkAppleVisionPro {
    ...
    private String resultFilePath = Paths.get(System.getProperty("user.dir"), "result__TestLinkAppleVisionPro.txt").toString();

    @Test
    @DisplayName("AppleVisionProLink")
    public void AppleVisionProLink() {
        ...
        checkElementVisibilityAndLog(Variables.appleVisionPro, "Product");
    }
    ...
    private void checkElementVisibilityAndLog(SelenideElement element, String elementName) {
        ...
        boolean isDisplayed = Variables.textAppleVisionPro.shouldBe(visible).exists();

        logVisibilityResult(elementName, isDisplayed);
        writeTestResult(elementName + " - Успешный переход на страницу Apple Vision Pro", isDisplayed);
    }
    ...
    private void logVisibilityResult(String elementName, boolean isDisplayed) {
        ...
        System.out.println(colorCode + elementName + " - Успешный переход на страницу Apple Vision Pro: " + result);
    }
