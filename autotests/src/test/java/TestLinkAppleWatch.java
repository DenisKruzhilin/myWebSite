...
public class TestLinkAppleWatch {
    ...
    private String resultFilePath = Paths.get(System.getProperty("user.dir"), "result__TestLinkAppleWatch.txt").toString();

    @Test
    @DisplayName("AppleWatchLink")
    public void AppleWatchLink() {
        ...
        checkElementVisibilityAndLog(Variables.appleWatch, "Product");
    }
    ...
    private void checkElementVisibilityAndLog(SelenideElement element, String elementName) {
        ...
        boolean isDisplayed = Variables.textAppleWatch.shouldBe(visible).exists();

        logVisibilityResult(elementName, isDisplayed);
        writeTestResult(elementName + " - Успешный переход на страницу Apple Watch", isDisplayed);
    }
    ...
    private void logVisibilityResult(String elementName, boolean isDisplayed) {
        ...
        System.out.println(colorCode + elementName + " - Успешный переход на страницу Apple Watch: " + result);
    }
