...
public class TestLinkConfidentialityPolicy {
    ...
    private String resultFilePath = Paths.get(System.getProperty("user.dir"), "result__TestLinkConfidentialityPolicy.txt").toString();

    @Test
    @DisplayName("ConfidentialityPolicyLink")
    public void ConfidentialityPolicyLink() {
        ...
        checkElementVisibilityAndLog(Variables.сonfidentialityPolicy, "Product");
    }
    ...
    private void checkElementVisibilityAndLog(SelenideElement element, String elementName) {
        ...
        boolean isDisplayed = Variables.сonfidentialityPolicyText.shouldBe(visible).exists();

        logVisibilityResult(elementName, isDisplayed);
        writeTestResult(elementName + " - Успешный переход на страницу политика конфиденциальности", isDisplayed);
    }
    ...
    private void logVisibilityResult(String elementName, boolean isDisplayed) {
        ...
        System.out.println(colorCode + elementName + " - Успешный переход на страницу политика конфиденциальности: " + result);
    }
