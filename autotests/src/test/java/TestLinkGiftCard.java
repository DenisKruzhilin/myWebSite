...
public class TestLinkGiftCard {
    ...
    public void GiftCardLink() {
        ...
        checkElementVisibilityAndLog(Variables.giftCard, "Product");
    }
    ...
    private void checkElementVisibilityAndLog(SelenideElement element, String elementName) {
        ...
        boolean isDisplayed = Variables.giftCardText.shouldBe(visible).exists();

        logVisibilityResult(elementName, isDisplayed);
        writeTestResult(elementName + " - Успешный переход на страницу подарочной карты", isDisplayed);
    }
    ...
    private void logVisibilityResult(String elementName, boolean isDisplayed) {
        ...
        System.out.println(colorCode + elementName + " - Успешный переход на страницу подарочной карты: " + result);
    }
