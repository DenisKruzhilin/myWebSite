...
public class TestLinkIPad {
    ...
    private String resultFilePath = Paths.get(System.getProperty("user.dir"), "result__TestLinkIPad.txt").toString();

    @Test
    @DisplayName("IPadLink")
    public void IPadLink() {
        ...
        checkElementVisibilityAndLog(Variables.ipad, "Product");
    }
    ...
    private void checkElementVisibilityAndLog(SelenideElement element, String elementName) {
        ...
        boolean isDisplayed = Variables.textIpad.shouldBe(visible).exists();

        logVisibilityResult(elementName, isDisplayed);
        writeTestResult(elementName + " - Успешный переход на страницу IPad", isDisplayed);
    }
    ...
    private void logVisibilityResult(String elementName, boolean isDisplayed) {
        ...
        System.out.println(colorCode + elementName + " - Успешный переход на страницу IPad: " + result);
    }
