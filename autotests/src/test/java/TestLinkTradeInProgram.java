...
public class TestLinkTradeInProgram {
    ...
    private String resultFilePath = Paths.get(System.getProperty("user.dir"), "result__TestLinkTradeInProgram.txt").toString();
    ...
    public void ConfidentialityPolicyLink() {
        ...
        checkElementVisibilityAndLog(Variables.tradeInPolicy, "Product");
    }
    ...
    private void checkElementVisibilityAndLog(SelenideElement element, String elementName) {
        ...
        boolean isDisplayed = Variables.tradeInPolicyText.shouldBe(visible).exists();

        logVisibilityResult(elementName, isDisplayed);
        writeTestResult(elementName + " - Успешный переход на страницу trade-in", isDisplayed);
    }
    ...
    private void logVisibilityResult(String elementName, boolean isDisplayed) {
        ...
        System.out.println(colorCode + elementName + " - Успешный переход на страницу trade-in: " + result);
    }
